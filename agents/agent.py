...
class DDPG():
    ...
    def learn(self, experiences):
        ...
        #  adding some prints to compare with python2.7 code
        #print("agent.py in learn method")
        #print(states[0])
        #print(actions[0])
        #print("Python3.5 agent.py saw those for states and actions")
        #a_g = self.critic_local.get_action_gradients([states, actions, 0])
        #print(type(a_g[0]))
        #print(a_g[0])
        #print("Python3.5 agent.py saw that action gradient")
    ...
    def soft_update(self, local_model, target_model):
        ...
        #print("we just updated model weights")
        #local_model.save_weights('modelJan20.weights.h5')
